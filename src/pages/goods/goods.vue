...
const defaultAddress = computed(() => {
  return addressStore.selectedAddress?.fullLocation + addressStore.selectedAddress?.address
})
...
<template>
  ...
  <scroll-view scroll-y class="viewport">
    ...
    <view class="goods">
      <!-- 商品主图 -->
      <view class="preview">
        <swiper @change="onChange($event)" circular>
      ...
      <view class="action">
        ...
        <view class="item arrow" @tap="openPopup('address')">
          ...
          <text class="text ellipsis">
            {{ defaultAddress ? defaultAddress : '请选择收获地址' }}</text
          >
        </view>
